...
layui.define(['code', 'element', 'table', 'util'], function(exports){
  ...
  layer.ready(function(){
    ...
    ;!function(){
      ...
      //云大使推广
      var notParter = local.notice_parter && new Date().getTime() - local.notice_parter < 1000*60*30;
      var elemParter = $('#layui-spm-event-parter');
      if(elemParter[0] && !notParter){
        var tipsIndex = layer.tips(
          ['<a href="https://fly.layui.com/jump/alyhot/" target="_blank" id="layui-spm-event-parter-tips" style="display: block; line-height: 30px; padding: 10px; text-align: center; font-size: 14px; background-image: linear-gradient(to right,#8510FF,#D025C2,#FF8B2D,#F64E2C); background-image: linear-gradient(to right,#7F3ED8,#813EDB,#FE7364,#FC6199); color: #fff;">'
            //,'<p>阿里云/2核/8G/5M/<strong>1399元/3年</strong></p>'
            ,'<p>三年仅 <strong>203元</strong> 购阿里云服务器</p>'
            ,'<p style="">新春之计 万象更新</p>'
          ,'</a>'].join('')
          ,'#layui-spm-event-parter'
          ,{
            tips: [3, '#803ED9'] //[3, '#9F17E9']
            ,maxWidth: 320
            ,time: 0
            ,anim: 5
            ,tipeMore: true
      ...
      var notLayuiAdmin = local.notice_20191111 && new Date().getTime() - local.notice_20191111 < 1000*60*60*24*3;
      if(0 && !notLayuiAdmin){
        setTimeout(function(){
          layer.open({
            type: 1
            ,title: 'layuiAdmin 2019 年度大特惠 <span class="layui-badge-dot" style="top: -2px; margin-left: 3px;"></span>'
            ,closeBtn: false
            ,area: ['300px', '280px']
            ,shade: false
            //,offset: 'b'
            ...
            ,content: ['<div style="padding: 15px; text-align: center; background-color: #e2e2e2;">'
              ,'<a href="https://fly.layui.com/acts/20191024.html" target="_blank"><img src="//cdn.layui.com/upload/2018_5/168_1527691799254_76462.jpg" alt="layuiAdmin" style="width: 100%; height:149.78px;"></a>'
            ,'</div>'].join('')
            ,success: function(layero, index){
              var btn = layero.find('.layui-layer-btn');
              btn.find('.layui-layer-btn0').attr({
                href: 'https://fly.layui.com/acts/20191024.html'
                ,target: '_blank'
              });
