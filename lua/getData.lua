...
local sql =
    "select ticket_idmsg from Tb_Win_Ticket_V2 where prize_flag = 0  order by insert_Timestamp asc ,ticket_idmsg asc"
local rtn_data={}
rtn_data.code=0
